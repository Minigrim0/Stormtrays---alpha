...
class QuestGiver(object):
    ...
    def __init__(self, FilePath):
        ...
        self.TabQuestsNum = []
        self.TabImg = []
        self.Image       = pygame.image.load("../Img/Perso/QuestGiver/QuestGiverF1.png" ).convert_alpha()
        self.FontTxt     = pygame.image.load("../Img/Perso/QuestGiver/QuestsFont.png").convert_alpha()
        self.TabImg.append(pygame.image.load("../Img/Perso/QuestGiver/QuestGiverF1.png" ).convert_alpha())
        self.TabImg.append(pygame.image.load("../Img/Perso/QuestGiver/QuestGiverF2.png").convert_alpha())
        self.TabImg.append(pygame.image.load("../Img/Perso/QuestGiver/QuestGiverF3.png").convert_alpha())
        self.TabImg.append(pygame.image.load("../Img/Perso/QuestGiver/QuestGiverF1.png" ).convert_alpha())
        self.TabImg.append(pygame.image.load("../Img/Perso/QuestGiver/QuestGiverF2.png").convert_alpha())
        self.TabImg.append(pygame.image.load("../Img/Perso/QuestGiver/QuestGiverF3.png").convert_alpha())
                ...
                if Objectives == 1:
                    if int(self.TabQuestsTypes[x]) == 1:
                        if DicoTowersBought["Archer"] < int(self.TabQuestsNum[x]):
                            TabNumsQuestsTxt.append(self.font.render(str(DicoTowersBought["Archer"])+"/"+str(int(self.TabQuestsNum[x])),  1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])),  1, (0, 200, 50)))
                            self.ObjectifDone[x] = True
                    elif int(self.TabQuestsTypes[x]) == 2:
                        if DicoTowersBought["Catapulte Basique"] < int(self.TabQuestsNum[x]):
                            TabNumsQuestsTxt.append(self.font.render(str(DicoTowersBought["Catapulte Basique"])+"/"+str(int(self.TabQuestsNum[x])),  1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])),  1, (0, 200, 50)))
                            self.ObjectifDone[x] = True
                    elif int(self.TabQuestsTypes[x]) == 3:
                        if DicoTowersBought["Catapulte Precise"] < int(self.TabQuestsNum[x]):
                            TabNumsQuestsTxt.append(self.font.render(str(DicoTowersBought["Catapulte Precise"])+"/"+str(int(self.TabQuestsNum[x])),  1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])),  1, (0, 200, 50)))
                            self.ObjectifDone[x] = True
                    elif int(self.TabQuestsTypes[x]) == 4:
                        if DicoTowersBought["Catapulte Rapide"] < int(self.TabQuestsNum[x]):
                            TabNumsQuestsTxt.append(self.font.render(str(DicoTowersBought["Catapulte Rapide"])+"/"+str(int(self.TabQuestsNum[x])),  1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])),  1, (0, 200, 50)))
                            self.ObjectifDone[x] = True
                    elif int(self.TabQuestsTypes[x]) == 5:
                        if DicoTowersBought["Catapulte tres rapide"] < int(self.TabQuestsNum[x]):
                            TabNumsQuestsTxt.append(self.font.render(str(DicoTowersBought["Catapulte tres rapide"])+"/"+str(int(self.TabQuestsNum[x])),  1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])),  1, (0, 200, 50)))
                            self.ObjectifDone[x] = True
                    elif int(self.TabQuestsTypes[x]) == 6:
                        if DicoTowersBought["Baliste"] < int(self.TabQuestsNum[x]):
                            TabNumsQuestsTxt.append(self.font.render(str(DicoTowersBought["Baliste"])+"/"+str(int(self.TabQuestsNum[x])),  1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])),  1, (0, 200, 50)))
                            self.ObjectifDone[x] = True
                elif Objectives == 2:
                    if int(self.TabQuestsTypes[x]) == 7:
                        if DicoEnnemisKilled["Wolf"] < int(self.TabQuestsNum[x]):
                            TabNumsQuestsTxt.append(self.font.render(str(DicoEnnemisKilled["Wolf"])+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 200, 50)))
                            self.ObjectifDone[x] = True
                    elif int(self.TabQuestsTypes[x]) == 8:
                        if DicoEnnemisKilled["Goblin"] < int(self.TabQuestsNum[x]):
                            TabNumsQuestsTxt.append(self.font.render(str(DicoEnnemisKilled["Goblin"])+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 200, 50)))
                            self.ObjectifDone[x] = True
                    elif int(self.TabQuestsTypes[x]) == 9:
                        if DicoEnnemisKilled["Golem"] < int(self.TabQuestsNum[x]):
                            TabNumsQuestsTxt.append(self.font.render(str(DicoEnnemisKilled["Golem"])+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 200, 50)))
                            self.ObjectifDone[x] = True
                    elif int(self.TabQuestsTypes[x]) == 10:
                        if DicoEnnemisKilled["Orc"] < int(self.TabQuestsNum[x]):
                            TabNumsQuestsTxt.append(self.font.render(str(DicoEnnemisKilled["Orc"])+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 200, 50)))
                            self.ObjectifDone[x] = True
                    elif int(self.TabQuestsTypes[x]) == 11:
                        if DicoEnnemisKilled["Knight"] < int(self.TabQuestsNum[x]):
                            TabNumsQuestsTxt.append(self.font.render(str(DicoEnnemisKilled["Knight"])+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 200, 50)))
                            self.ObjectifDone[x] = True
                    elif int(self.TabQuestsTypes[x]) == 12:
                        if DicoEnnemisKilled["Dwarf"] < int(self.TabQuestsNum[x]):
                            TabNumsQuestsTxt.append(self.font.render(str(DicoEnnemisKilled["Dwarf"])+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 200, 50)))
                            self.ObjectifDone[x] = True
                    elif int(self.TabQuestsTypes[x]) == 13:
                        if DicoEnnemisKilled["Dragon"] < int(self.TabQuestsNum[x]):
                            TabNumsQuestsTxt.append(self.font.render(str(DicoEnnemisKilled["Dragon"])+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 200, 50)))
                            self.ObjectifDone[x] = True
                    elif int(self.TabQuestsTypes[x]) == 14:
                        if DicoEnnemisKilled["Ghost"] < int(self.TabQuestsNum[x]):
                            TabNumsQuestsTxt.append(self.font.render(str(DicoEnnemisKilled["Ghost"])+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 200, 50)))
                            self.ObjectifDone[x] = True
                    elif int(self.TabQuestsTypes[x]) == 15:
                        if DicoEnnemisKilled["Ghost"] < int(self.TabQuestsNum[x]):
                            TabNumsQuestsTxt.append(self.font.render(str(DicoEnnemisKilled["PukeMonster"])+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 200, 50)))
                            self.ObjectifDone[x] = True
                    ...
                    if GoldGained[0] < int(self.TabQuestsNum[x]):
                        if GoldGained[0] > 1000000:
                            TabNumsQuestsTxt.append(self.font.render(str(GoldGained[0]//1000000)+"M"+"/"+str(int(self.TabQuestsNum[x])),  1, (0, 0, 0)))
                        elif GoldGained[0] > 1000:
                            TabNumsQuestsTxt.append(self.font.render(str(GoldGained[0]//1000)+"K"+"/"+str(int(self.TabQuestsNum[x])),  1, (0, 0, 0)))
                        else:
                            TabNumsQuestsTxt.append(self.font.render(str(GoldGained[0])+"/"+str(int(self.TabQuestsNum[x])), 1, (0, 0, 0)))
                    else:
                        TabNumsQuestsTxt.append(self.font.render(str(int(self.TabQuestsNum[x]))+"/"+str(int(self.TabQuestsNum[x])),  1, (0, 200, 50)))
                        self.ObjectifDone[x] = True
